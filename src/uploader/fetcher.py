...
class REDCapFetcher:
    ...
    def analyze_upload_data(self, upload_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            if not json_files:
                return {"success": False, "error": "No JSON files found in upload path", "files_analyzed": 0}

            all_fields: set[str] = set()
            all_record_ids: set[str] = set()
            all_qc_last_runs: set[str] = set()
            file_analysis = []
            ...
            qc_fields_in_upload = [
                field for field in all_fields if field in self.qc_status_fields and field != "redcap_event_name"
            ]
            ...
            return {"success": False, "error": error_msg, "files_analyzed": 0}
    ...
    def fetch_complete_backup_data(self) -> Dict[str, Any]:
        ...
        try:
            ...
            response = self.session.post(self.config.api_url, data=data, timeout=self.config.timeout)
    ...
    def fetch_qc_status_form_data(
        self, record_ids: Optional[List[str]] = None, qc_fields: Optional[List[str]] = None
    ) -> Dict[str, Any]:
        """
    ...
    def fetch_for_upload(self, upload_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            qc_result = self.fetch_qc_status_form_data(
                record_ids=analysis.get("record_ids"), qc_fields=analysis.get("qc_status_fields")
            )  # Combine results
            return {
                "success": True,
                "analysis": analysis,
    ...
    def fetch_qc_status_data(
        self, records: Optional[List[str]] = None, specific_fields: Optional[List[str]] = None
    ) -> Dict[str, Any]:
        """
    ...
    def export_qc_status_data(self, output_dir: Optional[Path] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": True, "file_path": str(file_path), "record_count": fetch_result["record_count"]}
    ...
    def get_records_with_qc_last_run(self, qc_last_run_values: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            result = self.fetch_qc_status_data(specific_fields=["record_id", "qc_last_run"])
    ...
    def save_fetched_data_to_output(
        self, data: Dict[str, Any], output_dir: Path, filename_prefix: str = "FETCHED_DATA", create_subdir: bool = True
    ) -> Dict[str, Any]:
        """
    ...
    def save_backup_files_to_directory(
        self, data: Dict[str, Any], output_dir: Path, upload_data: Optional[List[Dict[str, Any]]] = None
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {"success": True, "files_created": saved_files, "qc_backup_file": str(qc_backup_file)}
    ...
    def get_project_info(self) -> Dict[str, Any]:
        ...
        """
        try:
            data = {"token": self.config.api_token, "content": "project", "format": "json", "returnFormat": "json"}
